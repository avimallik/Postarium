...
public class RangpurActivity extends AppCompatActivity {
    ...
    String HttpURL = "http://www.armapprise.com/rangpur.php";
...
//                Toast.makeText(RangpurActivity.this, ListViewClickData.getSubName(), Toast.LENGTH_SHORT).show();
                Intent rangpurDispIntent = new Intent(RangpurActivity.this,DataDisp.class);
                rangpurDispIntent.putExtra("key_rangpur_11",ListViewClickData.getSubName());
                rangpurDispIntent.putExtra("key_rangpur_12",ListViewClickData.getSubFullForm());
                rangpurDispIntent.putExtra("key_rangpur_13",ListViewClickData.getSubPhone());
                startActivity(rangpurDispIntent);
        ...
        new RangpurActivity.ParseJSonDataClass(this).execute();
        ...
        reloadBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new RangpurActivity.ParseJSonDataClass(RangpurActivity.this).execute();
            }
        });
    ...
    private class ParseJSonDataClass extends AsyncTask<Void, Void, Void> {
...

        {
            ...
            listViewAdapter = new ListViewAdapter(RangpurActivity.this, R.layout.listview_items_layout, SubjectList);
    ...
    public void networkStateCheck(){
        ...
        if ((wifi != null & datac != null)
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(RangpurActivity.this);

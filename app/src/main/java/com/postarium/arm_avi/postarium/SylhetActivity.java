...
public class SylhetActivity extends AppCompatActivity {
    ...
    String HttpURL = "http://www.armapprise.com/sylhet.php";
...
//                Toast.makeText(SylhetActivity.this, ListViewClickData.getSubName(), Toast.LENGTH_SHORT).show();

                Intent sylhetDispIntent = new Intent(SylhetActivity.this,DataDisp.class);
                sylhetDispIntent.putExtra("key_sylhet_11",ListViewClickData.getSubName());
                sylhetDispIntent.putExtra("key_sylhet_12",ListViewClickData.getSubFullForm());
                sylhetDispIntent.putExtra("key_sylhet_13",ListViewClickData.getSubPhone());
                startActivity(sylhetDispIntent);
        ...
        reloadBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new ParseJSonDataClass(SylhetActivity.this).execute();
            }
        });
    ...
    private class ParseJSonDataClass extends AsyncTask<Void, Void, Void> {
...

        {
            ...
            listViewAdapter = new ListViewAdapter(SylhetActivity.this, R.layout.listview_items_layout, SubjectList);
            listView.setAdapter(listViewAdapter);
        }
    }


        //Network Connection State Check
        public void networkStateCheck(){
            ...
            if ((wifi != null & datac != null)
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(SylhetActivity.this);

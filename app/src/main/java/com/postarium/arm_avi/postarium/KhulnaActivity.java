...
public class KhulnaActivity extends AppCompatActivity {
    ...
    String HttpURL = "http://www.armapprise.com/khulna.php";
...
//                Toast.makeText(KhulnaActivity.this, ListViewClickData.getSubName(), Toast.LENGTH_SHORT).show();
                Intent khulnaDispIntent = new Intent(KhulnaActivity.this,DataDisp.class);
                khulnaDispIntent.putExtra("key_khulna_11",ListViewClickData.getSubName());
                khulnaDispIntent.putExtra("key_khulna_12",ListViewClickData.getSubFullForm());
                khulnaDispIntent.putExtra("key_khulna_13",ListViewClickData.getSubPhone());
                startActivity(khulnaDispIntent);
        ...
        new KhulnaActivity.ParseJSonDataClass(this).execute();
        ...
        reloadBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new KhulnaActivity.ParseJSonDataClass(KhulnaActivity.this).execute();
            }
        });
    ...
    private class ParseJSonDataClass extends AsyncTask<Void, Void, Void> {
...

        {
            ...
            listViewAdapter = new ListViewAdapter(KhulnaActivity.this, R.layout.listview_items_layout, SubjectList);
    ...
    public void networkStateCheck(){
        ...
        if ((wifi != null & datac != null)
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(KhulnaActivity.this);

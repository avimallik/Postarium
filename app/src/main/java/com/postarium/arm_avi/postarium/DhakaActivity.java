...
public class DhakaActivity extends AppCompatActivity {
    ...
    String HttpURL = "http://www.armapprise.com/dhaka.php";
...
//                Toast.makeText(DhakaActivity.this, ListViewClickData.getSubName(), Toast.LENGTH_SHORT).show();
                Intent dhakaDispIntent = new Intent(DhakaActivity.this,DataDisp.class);
                dhakaDispIntent.putExtra("key_dhaka_11",ListViewClickData.getSubName());
                dhakaDispIntent.putExtra("key_dhaka_12",ListViewClickData.getSubFullForm());
                dhakaDispIntent.putExtra("key_dhaka_13",ListViewClickData.getSubPhone());
                startActivity(dhakaDispIntent);
        ...
        new DhakaActivity.ParseJSonDataClass(this).execute();
        ...
        reloadBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new DhakaActivity.ParseJSonDataClass(DhakaActivity.this).execute();
            }
        });
    ...
    private class ParseJSonDataClass extends AsyncTask<Void, Void, Void> {
...

        {
            ...
            listViewAdapter = new ListViewAdapter(DhakaActivity.this, R.layout.listview_items_layout, SubjectList);
    ...
    public void networkStateCheck(){
        ...
        if ((wifi != null & datac != null)
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(DhakaActivity.this);

...
public class ChittagongActivity extends AppCompatActivity {
    ...
    String HttpURL = "http://www.armapprise.com/chittagong.php";
...
//                Toast.makeText(ChittagongActivity.this, ListViewClickData.getSubName(), Toast.LENGTH_SHORT).show();
                Intent chittagongDispIntent = new Intent(ChittagongActivity.this,DataDisp.class);
                chittagongDispIntent.putExtra("key_chittagong_11",ListViewClickData.getSubName());
                chittagongDispIntent.putExtra("key_chittagong_12",ListViewClickData.getSubFullForm());
                chittagongDispIntent.putExtra("key_chittagong_13",ListViewClickData.getSubPhone());
                startActivity(chittagongDispIntent);
        ...
        new ChittagongActivity.ParseJSonDataClass(this).execute();
        ...
        reloadBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new ChittagongActivity.ParseJSonDataClass(ChittagongActivity.this).execute();
            }
        });
    ...
    private class ParseJSonDataClass extends AsyncTask<Void, Void, Void> {
...

        {
            ...
            listViewAdapter = new ListViewAdapter(ChittagongActivity.this, R.layout.listview_items_layout, SubjectList);
    ...
    public void networkStateCheck(){
        ...
        if ((wifi != null & datac != null)
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(ChittagongActivity.this);

...
public class MymensinghActivity extends AppCompatActivity {
    ...
    String HttpURL = "http://www.armapprise.com/mymensingh.php";
...
//                Toast.makeText(MymensinghActivity.this, ListViewClickData.getSubName(), Toast.LENGTH_SHORT).show();
                Intent mymensinghDispIntent = new Intent(MymensinghActivity.this,DataDisp.class);
                mymensinghDispIntent.putExtra("key_mymensingh_11",ListViewClickData.getSubName());
                mymensinghDispIntent.putExtra("key_mymensingh_12",ListViewClickData.getSubFullForm());
                mymensinghDispIntent.putExtra("key_mymensingh_13",ListViewClickData.getSubPhone());
                startActivity(mymensinghDispIntent);
        ...
        new MymensinghActivity.ParseJSonDataClass(this).execute();
        ...
        reloadBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new MymensinghActivity.ParseJSonDataClass(MymensinghActivity.this).execute();
            }
        });
    ...
    private class ParseJSonDataClass extends AsyncTask<Void, Void, Void> {
...

        {
            ...
            listViewAdapter = new ListViewAdapter(MymensinghActivity.this, R.layout.listview_items_layout, SubjectList);
    ...
    public void networkStateCheck(){
        ...
        if ((wifi != null & datac != null)
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(MymensinghActivity.this);

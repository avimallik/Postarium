...
public class RajshahiActivity extends AppCompatActivity {
    ...
    String HttpURL = "http://www.armapprise.com/rajshahi.php";
...
//                Toast.makeText(RajshahiActivity.this, ListViewClickData.getSubName(), Toast.LENGTH_SHORT).show();
                Intent rajshahiDispIntent = new Intent(RajshahiActivity.this,DataDisp.class);
                rajshahiDispIntent.putExtra("key_rajshahi_11",ListViewClickData.getSubName());
                rajshahiDispIntent.putExtra("key_rajshahi_12",ListViewClickData.getSubFullForm());
                rajshahiDispIntent.putExtra("key_rajshahi_13",ListViewClickData.getSubPhone());
                startActivity(rajshahiDispIntent);
        ...
        new RajshahiActivity.ParseJSonDataClass(this).execute();
        ...
        reloadBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new RajshahiActivity.ParseJSonDataClass(RajshahiActivity.this).execute();
            }
        });
    ...
    private class ParseJSonDataClass extends AsyncTask<Void, Void, Void> {
...

        {
            ...
            listViewAdapter = new ListViewAdapter(RajshahiActivity.this, R.layout.listview_items_layout, SubjectList);
    ...
    public void networkStateCheck(){
        ...
        if ((wifi != null & datac != null)
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(RajshahiActivity.this);
